...
(function () {
    ...
    window.VizTuitionEarnings = {
      ...
      draw: function (p, manager) {
        ...
        var yMin = Math.min(...data.map(d => d.earn10)) * 0.9;
        var yMax = Math.max(...data.map(d => d.earn10)) * 1.1;
        ...
        data.forEach(d => {
          ...
          var y = p.map(d.earn10, yMin, yMax, offsetY + h - margin, offsetY + margin);
          p.ellipse(x, y, 5, 5);
        });
